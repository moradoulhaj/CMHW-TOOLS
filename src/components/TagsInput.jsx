...
export default function TagsInput({ tagsToRemove, setTagsToRemove ,setProcessedContents }) {
  ...
  return (
    <div className="w-full max-w-2xl">
      <label className="flex items-center gap-2 text-sm font-medium text-gray-700 mb-2">
        ...
        <span>Tags to Remove (one per line)</span>
      </label>
      <textarea
        value={tagsToRemove}
        ...
        placeholder="Tags to Remove (one per line):"
      />
    </div>
  );
}
